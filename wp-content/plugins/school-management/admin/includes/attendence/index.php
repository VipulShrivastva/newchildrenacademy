						...
						if(!empty($parent_list))
						{
							...
							foreach ($parent_list as $user_id)
							{
								...
								if($current_sms_service == 'twillo')
								{
									...
									$message = str_replace(" ","%20",$message_content); // Message Text
									//twilio object
	...
	{ ?>	 
    	...
    	<label for="subject_id">&nbsp;</label>
         ...
         <div class="panel-heading">
         	...
         	<?php _e('Date')?> : <?php echo $_POST['curr_date'];?></h4>
         </div>
        ...
        <table class="table">
            ...
            $i = 1;
             ...
             foreach ( $student as $user ) {
				...
				<td><input type="text" name="attendanace_comment_<?php echo $user->ID?>" class="form-control" value="<?php if($check_attendance->comment!='') echo $check_attendance->comment;?>"></td>
				<?php 
