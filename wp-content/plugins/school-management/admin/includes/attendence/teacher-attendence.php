...
?>
	...
	?>	 
    	...
    	<label for="subject_id">&nbsp;</label>
         ...
         ?>
          ...
          <div class="panel-heading">
         	<h4 class="panel-title"><?php _e('Teacher Attendance');?> , 
         	<?php _e('Date')?> : <?php echo $_POST['tcurr_date'];?></h4>
         </div>
		  <div class="col-md-12">
        <table class="table">
            <tr>
        ...
        <div class="col-sm-8">    
        <?php if($_REQUEST['tcurr_date'] == date("Y-m-d")){?>       	    	
        	<input type="submit" value="Save  Attendance" name="save_teach_attendence" class="btn btn-success" />
        	<?php }?>
        </div>
