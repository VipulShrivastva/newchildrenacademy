	  ...
	  $('#end_date').datepicker();
       ...
       <div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input id="date" class="datepicker form-control validate[required] text-input" type="text" value="<?php if($edit){ echo $holiday_data->date;}?>" name="date">				
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="date"><?php _e('End Date','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
				<input id="end_date" class="datepicker form-control validate[required] text-input" type="text" value="<?php if($edit){ echo $holiday_data->end_date;}?>" name="end_date">				
			</div>
		</div>
