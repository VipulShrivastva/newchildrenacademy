...
<div class="row mailbox-header">
 ...
 <div class="col-md-2">
                            <ul class="list-unstyled mailbox-nav">
                                ...
                                <a href="?page=smgt_message&tab=inbox"><i class="fa fa-inbox"></i> <?php _e('Inbox','school-mgt');?><span class="badge badge-success pull-right"><?php echo count(get_inbox_message(get_current_user_id()));?></span></a></li>
