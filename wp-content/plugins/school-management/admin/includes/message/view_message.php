	...
	<?php if(isset($_REQUEST['from']) && $_REQUEST['from']=='inbox')
		...
		{?>
			<div class="message-content">
				...
				<a href="admin.php?page=smgt_message&tab=view_message&action=delete-reply&from=<?php echo $_REQUEST['from'];?>&id=<?php echo $_REQUEST['id'];?>&reply_id=<?php echo $reply->id;?>"><?php _e('Delete','church_mgt');?></a></span> 
