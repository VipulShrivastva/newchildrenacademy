...
<?php  $edit=0;
       ...
       <div class="panel-body"> 
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
			<input id="notice_Start_date" class="datepicker form-control validate[required] text-input" type="text" value="<?php if($edit){ echo get_post_meta($post->ID,'start_date',true);}?>" name="start_date">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
			<input id="notice_end_date" class="datepicker form-control validate[required] text-input" type="text" value="<?php if($edit){ echo get_post_meta($post->ID,'end_date',true);}?>" name="end_date">
