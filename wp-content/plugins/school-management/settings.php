...
if ( is_admin() ){
	...
	function smgt_call_script_page()
	{
		$page_array = array('smgt_school','smgt_student','smgt_teacher','smgt_parent','smgt_Subject','smgt_class','smgt_route','smgt_attendence','smgt_exam',
				...
				'smgt_Migration','smgt_sms-setting','smgt_gnrl_settings','smgt_supportstaff','smgt_library');
		return  $page_array;
	}
function smgt_change_adminbar_css() {
	...
	wp_enqueue_script('smgt-popup', plugins_url( '/assets/js/popup.js', __FILE__ ), array( 'jquery' ), '4.1.1', true );
