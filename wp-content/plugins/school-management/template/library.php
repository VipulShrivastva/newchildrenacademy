 ...
 <ul class="nav nav-tabs panel_tabs" role="tablist">
	...
	if($active_tab == 'addbook')
	 ...
	 {?>
		...
		<div class="panel-body">
        <table id="bookissue_list" class="display" cellspacing="0" width="100%">
        	 <thead>
            <tr>
	...
	{?>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input id="return_date" class="form-control validate[required] text-input" type="text" name="return_date" value="<?php if($edit){ echo $result->end_date;}?>">
			</div>
		</div>
