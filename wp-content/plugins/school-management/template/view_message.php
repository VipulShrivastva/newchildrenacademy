   ...
   <?php if(isset($_REQUEST['from']) && $_REQUEST['from']=='inbox')
		...
		{?>
			<div class="message-content">
				...
				<a href="?dashboard=user&page=message&tab=view_message&action=delete-reply&from=<?php echo $_REQUEST['from'];?>&id=<?php echo $_REQUEST['id'];?>&reply_id=<?php echo $reply->id;?>"><?php _e('Delete','church_mgt');?></a></span> 
    ...
    <div class="message-content">
     <div class="col-sm-8">
	   ...
	   <div class="message-options pull-right reply-message-btn">
			<button type="submit" name="replay_message" class="btn btn-default"><i class="fa fa-reply m-r-xs"></i><?php _e('Replay','church_mgt')?></button>
